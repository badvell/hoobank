          ...
          >
            ...
            <ul className='list-none mt-4'>
              {footerLink.links.map((link, id) => (
                <li
                  key={link.name}
                  className={`font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary duration-300 cursor-pointer ${
                    id !== footerLink.links.lenght - 1 ? 'mb-4' : 'mb-0'
                  }`}
                >
                  {link.name}
                </li>
